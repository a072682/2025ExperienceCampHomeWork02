...
function BlogDetail() {
  ...
  return (
    <>
        <div className='bgd-main1 w-100'>
            <div className='bgd-main2-mb d-flex flex-column d-block d-xl-none'>
                <div className='bgd-main2-mb-bg1'></div>
                <div className='bgd-main2-mb-bg2'>
                    <div className="container">
                        <div className="row">
                            <div className="col">
                                <div className='bgd-mb-main2-card-box py-48 d-flex flex-column'>
                                    <div className="bgd-mb-main2-card1 border-0 h-100">
                                        <div className="bgd-mb-main2-card1-body d-flex flex-column">
                                            {/* 時間 */}
            ...
            <div className='bgd-main2-desktop d-none d-xl-block position-relative'>
                <div className='bgd-main2-desktop-bg d-flex'>
                    <div className='bgd-main2-desktop-bg1'>
                    </div>
                    <div className='bgd-main2-desktop-bg2'>     
                        <div className='bgd-dt-main2-card-box h-100 px-24 d-flex flex-column justify-content-center align-items-start'>
                            <div className="bgd-dt-main2-card1 border-0 ">
                                <div className="bgd-dt-main2-card1-body d-flex flex-column">
                                    {/* 時間 */}
                                    <time dateTime="2024-10-21" className="mb-4 fs-16 fw-500 col-000000 lh-15 fontFamily">2024/10/21</time>
                                    {/* 標籤 */}
                                    <div className="d-flex">
        ...
        <div className='bgd-main2 w-100 '>
        <div className='bgd-main2-mb py-64 border-top border-bottom border-3 border-secondary d-flex flex-column'>
                <div className="container">
                    <div className="row">
            ...
            <div className='bg-main3-desktop d-none d-xl-block'>
            </div> 
        </div>
    </>
  );
